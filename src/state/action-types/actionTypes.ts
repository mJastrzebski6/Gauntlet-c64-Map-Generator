export enum ActionType {
    ...
    UPDATE_START_HEALTH = "update_start_health",
    UPDATE_START_SCORE = "update_start_score",
    UPDATE_LEVEL_NUMBER = "update_level_number",
    UPDATE_WALLS_COLOR = "update_walls_color",
